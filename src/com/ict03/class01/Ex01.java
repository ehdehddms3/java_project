...
public class Ex01 {
	...
	// 클래스
	// 정의 : 객체(오브젝트, 인스턴스화)를 만들기 위한 모든 정보를 가지고 있는것
	// (설계도면, 거푸집등으로 표현한다.
	// 파일 형태로 되어있으면 **클래스를 객체로 만들어야만 사용 가능하다.
	...
	//      1) public     : 누구나 접근 가능
	//      2) protected  : 같은패키지와 상속관계에서는 접근 가능
	...
	//    3) 반환형 : 메소드느 자기를 호출한 곳으로 되돌아 간다.
	//                이 때 실행한 결과를 가지고 갈 때의 자료형을 반환형이라고 한다.
	//                만약에 실행한 결과를 가지고 가지 않을대는 반환형에 void라고 쓴다.
	//                예) public static void main(String[] args){}
	//                누구나 다 접근할 수 있고, static 메소드이며, 되돌아갈때 무언가를 가지고 가지않는다.
	...
	//        생성자가 보이지 않는 클래스는 기본생선자로 객체를 생성하게 된다.
